...
(function() {
  ...
  var App = {
    ...
    destroyCompleted: function () {
      ...
      for (var i = focusedTodo.children.length - 1; i >=0; i--) {
        var child = focusedTodo.children[i];
        this.traverseRight(child, function(todo) {
          if (todo.completed) {
            var parent = this.getTodo(todo.parentId);
            parent.children.splice(this.indexFromId(todo.id), 1);
          }
        }.bind(this));
      }
